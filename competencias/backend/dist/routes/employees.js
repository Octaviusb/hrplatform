...
router.post('/', requirePermission('employees.create'), async (req, res) => {
    try {
        const { employeeNumber, firstName, lastName, email, phone, identificationNumber, identificationType, departmentId, positionId, hireDate, salary, vacationDays, } = req.body;
